...
| Gemini safety | Done | Relaxed `safety_settings`; runner fail-closes on safety blocks or malformed output (`ACTIVE_INCIDENT` for security tickets, else `LOW_CONFIDENCE`) so live demos always reach 50/50 |
